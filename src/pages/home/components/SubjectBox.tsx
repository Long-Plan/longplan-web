	...
	return (
		<>
			...
			<div
				...
				className={`relative inline-flex items-start justify-end gap-[10px] pl-0 pr-[5px] py-0 rounded-[10px] border border-solid shadow-box-shadow cursor-pointer transition-all duration-300 transform group hover:scale-110 w-[110px] h-[45px]`} // Added cursor-pointer for visual feedback
			>
				<div
				...
				<div className="inline-flex flex-col h-[19px] items-start justify-end gap-[10px] relative flex-[0_0_auto]">
					...
					>
						{isEnrolled ? courseDetail.credit : 0}
					</div>
				</div>
			</div>
		</>
